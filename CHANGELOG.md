...
- This release aggregates all changes from release candidate 4.6.0-rc.1.
...
- Update `cluster-api-provider-azure` to `v1.25.2-gs-770f5f05d`.

## [4.5.1] - 2026-09-23

### Changed

- Update `cluster-api-provider-azure` to `v1.25.2-gs-c525bd5c2`.

## [4.5.0] - 2026-09-22

### Changed

- This release aggregates all changes from release candidates 4.5.0-rc.1 through 4.5.0-rc.3.
- Update `cluster-api-provider-azure` to `v1.25.2-gs-461182391`.
- Replace clusterctl-style environment substition with Kubernetes style
- Update `cluster-api-provider-azure` to `v1.25.2-gs-f70f6bf55`

## [4.5.0-rc.3] - 2026-09-22
...
- This release aggregates all changes from release candidate 4.4.0-rc.1.
- Update `cluster-api-provider-azure` to `v1.24.3-gs-0226b4d39`.

## [4.4.0-rc.1] - 2026-09-18
...
- Install the `insights.azure.com/DiagnosticSetting` and `eventhub.azure.com` ASO CRDs, so AKS clusters can enable API server audit logging.

### Changed

- Update `cluster-api-provider-azure` to `v1.23.0-gs-5b4414dd2`.
- Patch ASO's `--crd-pattern` argument by index with a `test` op, instead of restating the whole `args` list in a strategic merge patch. The old patch silently discarded any argument upstream added or changed.
...
- Chart: Update CAPZ to v1.23.0. ([#233](https://github.com/giantswarm/cluster-api-provider-azure-app/pull/233))
...
[Unreleased]: https://github.com/giantswarm/cluster-api-provider-azure-app/compare/v4.6.0...HEAD
...
[4.5.0-rc.3]: https://github.com/giantswarm/cluster-api-provider-azure-app/compare/v4.5.0-rc.2...v4.5.0-rc.3
...
[4.3.0]: https://github.com/giantswarm/cluster-api-provider-azure-app/compare/v4.2.3...v4.3.0
[4.2.3]: https://github.com/giantswarm/cluster-api-provider-azure-app/compare/v4.2.2...v4.2.3
[4.2.2]: https://github.com/giantswarm/cluster-api-provider-azure-app/compare/v4.2.1...v4.2.2
